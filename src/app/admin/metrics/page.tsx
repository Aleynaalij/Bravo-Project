...
export default async function MetricsPage({
  ...
  return (
    <main className="mx-auto max-w-3xl px-4 py-10">
      ...
      <Tabs items={TABS} active={tab} basePath="/admin/metrics" />
        ...
        <>
          ...
          <Card className="mb-8 flex flex-col gap-3">
            ...
            <p className="text-sm text-muted">
              ...
              only one of the two looks like a plausible candidate for the other. A pairing needs
              to appear for at least 2 accounts before it counts as a pattern.
            </p>
                      ...
                      {crossSell.opportunities.map((opportunity, index) => (
                        ...
                        >
                          ...
                          <span className="flex flex-wrap gap-2">
                            ...
                            <Badge tone="warning">
                              missing {SERVICE_LABELS[opportunity.missingService]}
                            </Badge>
                          </span>
                        </li>
                      ))}
