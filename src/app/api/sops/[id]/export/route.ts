...
// SOPs had no export path at all before this — Ask Que's "generate me an
// SOP" flow needed one to make good on "produces a download Word doc",
// and it was a genuine gap on the manual SOP library too (every
// deliverable type already exports to DOCX/PDF/PPTX; SOPs/Playbooks never
// got the same treatment). Scoped to DOCX only for now, matching what
