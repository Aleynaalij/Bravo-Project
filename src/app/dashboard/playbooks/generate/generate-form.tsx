...
import { generatePlaybookAction, type GeneratePlaybookFormState } from "./actions";
...
export function GenerateForm({ projects }: { projects: ProjectRow[] }) {
  const [state, formAction, isPending] = useActionState(generatePlaybookAction, initialState);
    ...
    <form action={formAction} className="flex flex-col gap-6">
      ...
      <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
        <Field id="playbookType" label="Playbook type">
          <select id="playbookType" name="playbookType" required defaultValue={PLAYBOOK_TYPES[0]} className={fieldClass}>
      ...
      <Field
        ...
        hint="Environment specifics, tools, or anything you want this playbook to reflect"
      >
