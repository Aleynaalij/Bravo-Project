...
// every Ask Que request's prompt so it can answer "how do I do X in here"
// questions, not just general Microsoft Purview questions. Kept as a
// plain constant (not pulled from a CMS or docs file) — the audience is
